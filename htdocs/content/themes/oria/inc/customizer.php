...
function oria_customize_preview_js() {
	wp_enqueue_script( 'oria_customizer', get_template_directory_uri() . '/dist/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'oria_customize_preview_js' );

function oria_registers() {
	wp_enqueue_script( 'oria_customizer_script', get_template_directory_uri() . '/dist/js/oria_customizer.js', array("jquery"), '20120206', true  );
