 ...
 */
	...
	function oria_slider_scripts() {
			wp_enqueue_script( 'oria-owl-script', get_template_directory_uri() .  '/dist/js/owl.carousel.min.js', array( 'jquery' ), true );
			wp_enqueue_script( 'oria-slider-init', get_template_directory_uri() .  '/dist/js/slider-init.js', array( 'jquery' ), true );
				...
				<div class="featured-inner clearfix">
					...
					<?php while ( $query->have_posts() ) : $query->the_post(); ?>
						<div class="slide">
							...
							<?php else : ?>
								<?php echo '<img src="' . get_stylesheet_directory_uri() . '/dist/images/placeholder.png"/>'; ?>
							<?php endif; ?>
