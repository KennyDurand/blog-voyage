...
function oria_scripts() {
	...
	wp_enqueue_style( 'oria-fontawesome', get_template_directory_uri() . '/dist/fonts/font-awesome.min.css' );

	wp_enqueue_script( 'oria-skip-link-focus-fix', get_template_directory_uri() . '/dist/js/skip-link-focus-fix.js', array(), '20130115', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}

	wp_enqueue_script( 'oria-fitvids', get_template_directory_uri() . '/dist/js/jquery.fitvids.js', array('jquery'), true );

	wp_enqueue_script( 'oria-slicknav', get_template_directory_uri() . '/dist/js/jquery.slicknav.min.js', array('jquery'), true );

	wp_enqueue_script( 'oria-parallax', get_template_directory_uri() . '/dist/js/parallax.min.js', array('jquery'), true );

	wp_enqueue_script( 'oria-scripts', get_template_directory_uri() . '/dist/js/scripts.js', array('jquery'), true );

	wp_enqueue_script( 'oria-imagesloaded', get_template_directory_uri() . '/dist/js/imagesloaded.pkgd.min.js', array( 'jquery', 'masonry' ), true );

	wp_enqueue_script( 'oria-masonry-init', get_template_directory_uri() . '/dist/js/masonry-init.js', array( 'jquery' ), true );
...
function oria_enqueue_bootstrap() {
	wp_enqueue_style( 'oria-style', get_template_directory_uri() . '/dist/css/style.css', array(), true );
	wp_enqueue_style( 'oria-bootstrap', get_template_directory_uri() . '/dist/css/bootstrap/bootstrap.min.css', array(), true );
}
...
function oria_html5shiv() {
    echo '<!--[if lt IE 9]>' . "\n";
    echo '<script src="' . esc_url( get_template_directory_uri() . '/dist/js/html5shiv.js' ) . '"></script>' . "\n";
    echo '<![endif]-->' . "\n";
}
